    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (command != "Clone them!")
            {
                ...
                if (subsequence > bestSubsequencest || (subsequence == bestSubsequencest && leftIndex < leftMostIndex) || (subsequence == bestSubsequencest && leftIndex == leftMostIndex && sum > bestSequenceSum))
                {
                    bestSubsequencest = subsequence;
